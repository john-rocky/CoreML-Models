...
public extension StableDiffusionPipeline {
    ...
    struct ResourceURLs {
        ...
        public init(resourcesAt baseURL: URL) {
            textEncoderURL = baseURL.appending(path: "HyperSDTextEncoder.mlmodelc")
            unetURL = baseURL.appending(path: "HyperSDUnet.mlmodelc")
            unetChunk1URL = baseURL.appending(path: "HyperSDUnetChunk1.mlmodelc")
            unetChunk2URL = baseURL.appending(path: "HyperSDUnetChunk2.mlmodelc")
            decoderURL = baseURL.appending(path: "HyperSDVAEDecoder.mlmodelc")
